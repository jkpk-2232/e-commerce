...
<html lang="en" data-bs-theme="dark">
	...
	<head>
		...
		<title><%=BusinessAction.messageForKeyAdmin("labelManageADs")%></title>
	</head>
	...
	<body>
		...
		<div id="content" class="app-content">
			...
			<%=NewThemeUiUtils.outputPageHeader(BusinessAction.messageForKeyAdmin("labelManageADs"), UrlConstants.JSP_URLS.MANAGE_AD_DASHBOARD_ICON)%>
			...
			<div id="formGrid" class="mb-5">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<%=NewThemeUiUtils.outputButtonSingleField("btnAddAD", BusinessAction.messageForKeyAdmin("labelAddAD"), NewThemeUiUtils.BUTTON_FLOAT_LEFT, NewThemeUiUtils.BUTTON_FLOAT_LEFT)%>
						...
						<% 
							...
							columnNames.add(BusinessAction.messageForKeyAdmin("labelADId"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelADTitle"));
