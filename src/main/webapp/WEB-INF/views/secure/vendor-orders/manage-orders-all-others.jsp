...
<html lang="en" data-bs-theme="dark">
	...
	<head>
		...
		<title><%=BusinessAction.messageForKeyAdmin("labelManageAllOtherOrders")%></title>
	</head>
	...
	<body>
		...
		<div id="content" class="app-content">
			...
			<%=NewThemeUiUtils.outputPageHeader(BusinessAction.messageForKeyAdmin("labelManageAllOtherOrders"), UrlConstants.JSP_URLS.MANAGE_PRODUCT_ICON)%>
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<% 
							...
							filterOptionIds.put(FieldConstants.ORDER_STATUS_FILTER, false);
							filterOptionIds.put(FieldConstants.VENDOR_ORDER_MANAGEMENT, false);
						%>
						...
						<% 
							...
							columnNames.add(BusinessAction.messageForKeyAdmin("labelOrderTime"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelCustomerName"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelCustomerAddress"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelVendorName"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelTotal"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelDeliveryCharges"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelCharges"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelNoOfItems"));
						...
						<%=NewThemeUiUtils.outputFormHiddenField(ProjectConstants.STATUS_TYPE, it)%>
