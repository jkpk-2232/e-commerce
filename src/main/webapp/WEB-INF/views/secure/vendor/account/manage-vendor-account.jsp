...
<html lang="en" data-bs-theme="dark">
	...
	<head>
		...
		<title><%=BusinessAction.messageForKeyAdmin("labelVendorAccount")%></title>
	</head>
	...
	<body>
		...
		<div id="content" class="app-content">
			...
			<%=NewThemeUiUtils.outputPageHeader(BusinessAction.messageForKeyAdmin("labelVendorAccount"), UrlConstants.JSP_URLS.MANAGE_VENDOR_ACCOUNT_ICON)%>
			...
			<%@include file="/WEB-INF/views/includes/encash-request-modal.jsp"%>
			<%=NewThemeUiUtils.outputFormHiddenField("userIdHiddenForEncash", it)%>
