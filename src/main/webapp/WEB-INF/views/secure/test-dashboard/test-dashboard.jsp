...
<!-- 	<!-- ================== BEGIN core-css ================== --> -->
<!-- 	<link href="dist/dist/assets/css/vendor.min.css" rel="stylesheet"> -->
<!-- 	<link href="dist/dist/assets/css/app.min.css" rel="stylesheet"> -->
<!-- 	<!-- ================== END core-css ================== --> -->
	
<!-- 	<!-- ================== BEGIN page-css ================== --> -->
<!-- 	<link href="dist/dist/assets/plugins/jvectormap-next/jquery-jvectormap.css" rel="stylesheet"> -->
<!-- 	<!-- ================== END page-css ================== --> -->
...
<body>
				...
				<div class="menu-item dropdown dropdown-mobile-full">
					<a href="#" data-bs-toggle="dropdown" data-bs-display="static" class="menu-link">
						<div class="menu-img online">
							<img src="dist/assets/img/user/profile.jpg" alt="Profile" height="60">
						</div>
									...
									<tbody>
											...
											<td>
												<div class="d-flex">
													<div class="position-relative mb-2">
														<div class="bg-position-center bg-size-cover bg-repeat-no-repeat w-80px h-60px" style="background-image: url(dist/assets/img/dashboard/product-1.jpeg);">
														</div>
										...
										<tr>
											<td>
												<div class="d-flex mb-2 align-items-center">
													<div class="position-relative">
														<div class="bg-position-center bg-size-cover bg-repeat-no-repeat w-80px h-60px" style="background-image: url(dist/assets/img/dashboard/product-2.jpeg);">
														</div>
														<div class="position-absolute top-0 start-0">
										...
										<tr>
											<td>
												<div class="d-flex mb-2 align-items-center">
													<div class="position-relative">
														<div class="bg-position-center bg-size-cover bg-repeat-no-repeat w-80px h-60px" style="background-image: url(dist/assets/img/dashboard/product-3.jpeg);">
														</div>
														<div class="position-absolute top-0 start-0">
										...
										<tr>
											<td>
												<div class="d-flex mb-2 align-items-center">
													<div class="position-relative">
														<div class="bg-position-center bg-size-cover bg-repeat-no-repeat w-80px h-60px" style="background-image: url(dist/assets/img/dashboard/product-4.jpeg);">
														</div>
														<div class="position-absolute top-0 start-0">
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													<div class="position-relative">
														<div class="bg-position-center bg-size-cover bg-repeat-no-repeat w-80px h-60px" style="background-image: url(dist/assets/img/dashboard/product-5.jpeg);">
														</div>
														<div class="position-absolute top-0 start-0">
							...
							<div class="row gx-2">
								<div class="col-6">
									<a href="javascript:;" data-toggle="theme-mode-selector" data-theme-mode="dark" class="app-theme-mode-link active">
										<div class="img"><img src="dist/assets/img/mode/dark.jpg" class="object-fit-cover" height="76" width="76" alt="Dark Mode"></div>
										<div class="text">Dark</div>
									</a>
								</div>
								<div class="col-6">
									<a href="javascript:;" data-toggle="theme-mode-selector" data-theme-mode="light" class="app-theme-mode-link">
										<div class="img"><img src="dist/assets/img/mode/light.jpg" class="object-fit-cover" height="76" width="76" alt="Light Mode"></div>
	...
	<!-- ================== BEGIN core-js ================== -->
<!-- 	<script src="dist/dist/assets/js/vendor.min.js"></script> -->
<!-- 	<script src="dist/dist/assets/js/app.min.js"></script> -->
	<!-- ================== END core-js ================== -->
