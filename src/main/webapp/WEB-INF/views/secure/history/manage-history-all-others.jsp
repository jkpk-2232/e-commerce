...
<html>
    ...
    <head>
        ...
        <title>Manage All Other Orders</title>
...
<%-- 				                    		<%=NewUiViewUtils.outputSelectFieldCellWithlabelAndSearchFieldForFilters("categoryId", null, true, 1, it, "margin-top: 10px;margin-left: -15%;")%> --%>
		                        		...
		                        		<div class="control-group">
				                    		...
				                    		<%=NewUiViewUtils.outputSelectFieldCellWithlabelAndSearchFieldForFilters("vendorOrderManagement", null, true, 1, it, "margin-top: 35px;")%>
		                    	...
		                    	%>
		                    		<div class="control-group">
			                    		...
			                    		<%=NewUiViewUtils.outputSelectFieldCellWithlabelAndSearchFieldForFilters("vendorOrderManagement", null, true, 1, it, "margin-top: 10px;margin-left: -14%;")%>
		                        		<div class="dashboardSeperator"></div>
		                        		<div class="dashboardSeperator"></div>
		                        	</div>	
		                    	<% 
