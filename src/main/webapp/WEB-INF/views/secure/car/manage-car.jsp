...
<html lang="en" data-bs-theme="dark">
	...
	<head>
		...
		<title><%=BusinessAction.messageForKeyAdmin("labelCars")%></title>
	</head>
	...
	<body>
		...
		<div id="content" class="app-content">
			...
			<%=NewThemeUiUtils.outputPageHeader(BusinessAction.messageForKeyAdmin("labelCars"), UrlConstants.JSP_URLS.MANAGE_CAR_ICON)%>
			...
			<div id="formGrid" class="mb-5">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<%=NewThemeUiUtils.outputButtonSingleField("btnAddCar", BusinessAction.messageForKeyAdmin("labelAddCar"), NewThemeUiUtils.BUTTON_FLOAT_RIGHT, NewThemeUiUtils.BUTTON_FLOAT_RIGHT)%>
						...
						<% 
							...
							columnNames.add(BusinessAction.messageForKeyAdmin("labelModelName"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelCarType"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelCarColor"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelCarPlateNo"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelPurchaseYear"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelCapacity"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelOwner"));
