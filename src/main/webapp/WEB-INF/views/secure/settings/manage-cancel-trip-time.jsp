			...
			<div class="">
				...
				<div class="page-title">
					<div class="title_left">
						<h3><%=it.get("labelCancelTripTime").toString() %></h3>
					</div>
				</div>
									...
									<div class="cancellationChargesDetailsPage">
										...
										<div class="cancellationChargesRightMenu">
											...
											<div class="cancellationChargesInfo">
												...
												<form id="edit-cancel-time" name="edit-cancel-time" action="${pageContext.request.contextPath}/manage-cancel-trip-time.do" method="post" >
													...
													<div style="margin-top: 20px;">
														<div class="cancellationChargesDiv">
															<label id="cancellationChargesLabel" class=""><%=it.get("labelCancelTripTime").toString() %>  <span style="color: #FF0000;">*</span></label>
															<%=ViewUtils.outputCancellationChargesNumberFieldCell("cancelTime", "", false, 1, 20, it)%>
														</div>
													</div>
