...
<html lang="en" data-bs-theme="dark">
	...
	<head>
		...
		<title><%=BusinessAction.messageForKeyAdmin("labelAppointmentSettings")%></title>
	</head>
	...
	<body>
		...
		<div id="content" class="app-content">
			...
			<%=NewThemeUiUtils.outputPageHeader(BusinessAction.messageForKeyAdmin("labelAppointmentSettings"), UrlConstants.JSP_URLS.MANAGE_APPOINTMENT_SETTINGS_ICON)%>
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<% 
							...
							columnNames.add(BusinessAction.messageForKeyAdmin("labelMinimumBookingTime"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelMaximumBookingTime"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelFreeCancellationTimeMins"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelCronJobExpireTimeMins"));
