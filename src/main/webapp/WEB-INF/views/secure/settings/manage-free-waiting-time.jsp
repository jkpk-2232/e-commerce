			...
			<div class="">
				...
				<div class="page-title">
					<div class="title_left">
						<h3><%=it.get("labelFreeWaitingTime").toString() %></h3>
					</div>
				</div>
									...
									<div class="cancellationChargesDetailsPage">
										...
										<div class="cancellationChargesRightMenu">
											...
											<div class="cancellationChargesInfo">
												...
												<form id="freeWaitingTime" name="freeWaitingTime" action="${pageContext.request.contextPath}/free-waiting-time.do" method="post" >
													...
													<div style="margin-top: 20px;">
														<div class="cancellationChargesDiv">
															<label id="cancellationChargesLabel" class=""><%=it.get("labelWaitingTime").toString() %>  <span style="color: #FF0000;">*</span></label>
															<%=ViewUtils.outputCancellationChargesNumberFieldCell("waitingTime", "", false, 1, 20, it)%>
														</div>
													</div>
