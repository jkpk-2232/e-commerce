...
<html lang="en" data-bs-theme="dark">
	...
	<body>
		...
		<div id="content" class="app-content">
			...
			<%=NewThemeUiUtils.outputPageHeader(BusinessAction.messageForKeyAdmin("labelManageDynamicCars"), UrlConstants.JSP_URLS.MANAGE_ADMIN_SETTINGS_ICON)%>
			...
			<div id="formGrid" class="mb-5">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<%=NewThemeUiUtils.outputButtonSingleField("btnAddCarType", BusinessAction.messageForKeyAdmin("labelAddCarType"), NewThemeUiUtils.BUTTON_FLOAT_LEFT, NewThemeUiUtils.BUTTON_FLOAT_LEFT)%>
						...
						<% 
							...
							columnNames.add(BusinessAction.messageForKeyAdmin("labelCarTypeName"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelCarTypeStatus"));
