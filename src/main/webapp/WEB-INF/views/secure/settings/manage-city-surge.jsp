...
<html lang="en" data-bs-theme="dark">
	...
	<head>
		...
		<title><%=BusinessAction.messageForKeyAdmin("labelManageCitySurge")%></title>
	</head>
	...
	<body>
		...
		<div id="content" class="app-content">
			...
			<%=NewThemeUiUtils.outputPageHeader(BusinessAction.messageForKeyAdmin("labelManageCitySurge"), UrlConstants.JSP_URLS.MANAGE_CITY_SURGE_ICON)%>
			...
			<div id="formGrid" class="mb-5">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<%=NewThemeUiUtils.outputButtonSingleField("btnAddCitySurge", BusinessAction.messageForKeyAdmin("labelAddCitySurge"), NewThemeUiUtils.BUTTON_FLOAT_LEFT, NewThemeUiUtils.BUTTON_FLOAT_LEFT)%>
