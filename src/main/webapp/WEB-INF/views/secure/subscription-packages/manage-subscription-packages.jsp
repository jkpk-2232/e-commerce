...
<html lang="en" data-bs-theme="dark">
	...
	<head>
		...
		<title><%=BusinessAction.messageForKeyAdmin("labelManageSubscriptionPackages")%></title>
	</head>
	...
	<body>
		...
		<div id="content" class="app-content">
			...
			<%=NewThemeUiUtils.outputPageHeader(BusinessAction.messageForKeyAdmin("labelManageSubscriptionPackages"), UrlConstants.JSP_URLS.MANAGE_SUBSCRIPTION_PACKAGE_ICON)%>
			...
			<div id="formGrid" class="mb-5">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<%=NewThemeUiUtils.outputButtonSingleField("btnAddSubscriptionPackage", BusinessAction.messageForKeyAdmin("labelAddSubscriptionPackage"), NewThemeUiUtils.BUTTON_FLOAT_LEFT, NewThemeUiUtils.BUTTON_FLOAT_LEFT)%>
						...
						<% 
							...
							columnNames.add(BusinessAction.messageForKeyAdmin("labelDurationInDays"));
