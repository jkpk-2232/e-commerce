				...
				<div class="card">
					...
					<div class="card-body">
						...
						<% 
							...
							columnNames.add(BusinessAction.messageForKeyAdmin("labelPhone"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelDriverDutyStatus"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelState"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelLastLocationTime"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelTotalLoggedInHours"));
