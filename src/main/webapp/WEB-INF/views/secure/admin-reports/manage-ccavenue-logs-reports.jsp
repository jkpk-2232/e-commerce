...
<html lang="en" data-bs-theme="dark">
	...
	<head>
		...
		<title><%=BusinessAction.messageForKeyAdmin("labelCcavenueLogsReports")%></title>
	</head>
	...
	<body>
		...
		<div id="content" class="app-content">
			...
			<%=NewThemeUiUtils.outputPageHeader(BusinessAction.messageForKeyAdmin("labelCcavenueLogsReports"), UrlConstants.JSP_URLS.MANAGE_REPORTS_ICON)%>
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<% 
							...
							filterOptionIds.put(FieldConstants.CCAVENUE_STATUS, false);
						%>
						...
						<% 
							...
							columnNames.add(BusinessAction.messageForKeyAdmin("labelEventId"));
							...
							columnNames.add(BusinessAction.messageForKeyAdmin("labelFailureMessage"));
							...
							columnNames.add(BusinessAction.messageForKeyAdmin("labelCurrency"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelPaymentMode"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelCardName"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelBankRefNo"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelBankResponseCode"));
						%>
