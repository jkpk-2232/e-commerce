...
<html lang="en" data-bs-theme="dark">
	...
	<head>
		...
		<title><%=BusinessAction.messageForKeyAdmin("labelAddProductImage")%></title>
	</head>
	...
	<body>
		...
		<div id="content" class="app-content">
			...
			<%=NewThemeUiUtils.outputPageHeader(BusinessAction.messageForKeyAdmin("labelAddProductImage"), "")%>
			...
			<div id="formGrid" class="mb-5">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<form method="POST" id="add-product-image" name="add-product-image" action="${pageContext.request.contextPath}<%=UrlConstants.PAGE_URLS.ADD_PRODUCT_IMAGE_URL%>">
