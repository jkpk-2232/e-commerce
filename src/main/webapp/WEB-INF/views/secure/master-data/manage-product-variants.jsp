...
<html lang="en" data-bs-theme="dark">
	...
	<head>
		...
		<title><%=BusinessAction.messageForKeyAdmin("labelManageProductVariants")%></title>
	</head>
	...
	<body>
		...
		<div id="content" class="app-content">
			...
			<%=NewThemeUiUtils.outputPageHeader(BusinessAction.messageForKeyAdmin("labelManageProductVariants"), UrlConstants.JSP_URLS.MANAGE_PRODUCT_VARIANT_DASHBOARD_ICON)%>
			...
			<div id="formGrid" class="mb-5">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<%=NewThemeUiUtils.outputButtonSingleField("btnAddProductVariant", BusinessAction.messageForKeyAdmin("labelAddProductVariant"), NewThemeUiUtils.BUTTON_FLOAT_RIGHT, NewThemeUiUtils.BUTTON_FLOAT_RIGHT)%>
						...
						<% 
							...
							columnNames.add(BusinessAction.messageForKeyAdmin("labelVariantDescription"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelUnits"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelProductBarcode"));
