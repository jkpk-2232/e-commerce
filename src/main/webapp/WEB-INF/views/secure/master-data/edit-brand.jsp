...
<html lang="en" data-bs-theme="dark">
	...
	<head>
		...
		<title><%=BusinessAction.messageForKeyAdmin("labelEditBrand")%></title>
	</head>
	...
	<body>
		...
		<div id="content" class="app-content">
			...
			<%=NewThemeUiUtils.outputPageHeader(BusinessAction.messageForKeyAdmin("labelEditBrand"), "")%>
			...
			<div id="formGrid" class="mb-5">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<form method="POST" id="edit-brand" name="edit-brand" action="${pageContext.request.contextPath}<%=UrlConstants.PAGE_URLS.EDIT_BRAND_URL%>">
							...
							<%=NewThemeUiUtils.outputFormHiddenField(FieldConstants.BRAND_ID, it)%>
