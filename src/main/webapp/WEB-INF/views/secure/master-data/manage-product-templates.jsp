...
<html lang="en" data-bs-theme="dark">
	...
	<head>
		...
		<title><%=BusinessAction.messageForKeyAdmin("labelManageProductTemplate")%></title>
	</head>
	...
	<body>
		...
		<div id="content" class="app-content">
			...
			<%=NewThemeUiUtils.outputPageHeader(BusinessAction.messageForKeyAdmin("labelManageProductTemplate"),   UrlConstants.JSP_URLS.MANAGE_PRODUCT_TEMPLATE_DASHOARD_ICON)%>
			...
			<div id="formGrid" class="mb-5">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<%=NewThemeUiUtils.outputButtonSingleField("btnAddProductTemplate", BusinessAction.messageForKeyAdmin("labelAddProductTemplate"), NewThemeUiUtils.BUTTON_FLOAT_RIGHT, NewThemeUiUtils.BUTTON_FLOAT_RIGHT)%>
						...
						<% 
							...
							columnNames.add(BusinessAction.messageForKeyAdmin("labelProductInformation"));
