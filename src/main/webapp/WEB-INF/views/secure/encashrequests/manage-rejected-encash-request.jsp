...
<html lang="en" data-bs-theme="dark">
	...
	<head>
		...
		<title><%=BusinessAction.messageForKeyAdmin("labelRejectedEncashRequests")%></title>
	</head>
	...
	<body>
		...
		<div id="content" class="app-content">
			...
			<%=NewThemeUiUtils.outputPageHeader(BusinessAction.messageForKeyAdmin("labelRejectedEncashRequests"), UrlConstants.JSP_URLS.MANAGE_REJECTED_ENCASH_REQUEST_ICON)%>
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<% 
							...
							columnNames.add(BusinessAction.messageForKeyAdmin("labelRejectedDate"));
