...
<html lang="en" data-bs-theme="dark">
	...
	<head>
		...
		<title><%=BusinessAction.messageForKeyAdmin("labelManageVendorStore")%></title>
	</head>
	...
	<body>
		...
		<div id="content" class="app-content">
			...
			<%=NewThemeUiUtils.outputPageHeader(BusinessAction.messageForKeyAdmin("labelManageVendorStore"), UrlConstants.JSP_URLS.VENDOR_STORE_LOCATION_ICON)%>
			...
			<div id="formGrid" class="mb-5">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						%>
							<%=NewThemeUiUtils.outputButtonSingleField("btnAddVendorStore", BusinessAction.messageForKeyAdmin("labelAddVendorStore"), NewThemeUiUtils.BUTTON_FLOAT_RIGHT, NewThemeUiUtils.BUTTON_FLOAT_RIGHT)%>
						<%
							}
						%>
						...
						<% 
							...
							columnNames.add(BusinessAction.messageForKeyAdmin("labelStoreAddress"));
