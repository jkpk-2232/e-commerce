...
<html lang="en" data-bs-theme="dark">
	...
	<body>
		...
		<div id="content" class="app-content">
			...
			<%=NewThemeUiUtils.outputPageHeader(BusinessAction.messageForKeyAdmin("labelOwnStore"),  UrlConstants.JSP_URLS.MANAGE_OWN_STORE_DASHBOARD_ICON)%>
			...
			<div id="formGrid" class="mb-5">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<%=NewThemeUiUtils.outputButtonSingleField(" ", BusinessAction.messageForKeyAdmin("labelAddOwnStores"), NewThemeUiUtils.BUTTON_FLOAT_RIGHT, NewThemeUiUtils.BUTTON_FLOAT_RIGHT)%>
