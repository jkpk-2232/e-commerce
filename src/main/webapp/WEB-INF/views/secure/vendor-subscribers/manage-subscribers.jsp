...
<html lang="en" data-bs-theme="dark">
	...
	<head>
		...
		<title><%=BusinessAction.messageForKeyAdmin("labelManageSubscribers")%></title>
	</head>
	...
	<body>
		...
		<div id="content" class="app-content">
			...
			<%=NewThemeUiUtils.outputPageHeader(BusinessAction.messageForKeyAdmin("labelManageSubscribers"), UrlConstants.JSP_URLS.MANAGE_SUBSCRIBERS_ICON)%>
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<% 
							...
							columnNames.add(BusinessAction.messageForKeyAdmin("labelSubscriberName"));
						%>
