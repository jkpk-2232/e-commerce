...
<html lang="en" data-bs-theme="dark">
	...
	<head>
		...
		<title><%=BusinessAction.messageForKeyAdmin("labelManageSuperServices")%></title>
	</head>
	...
	<body>
		...
		<div id="content" class="app-content">
			...
			<%=NewThemeUiUtils.outputPageHeader(BusinessAction.messageForKeyAdmin("labelManageSuperServices"), UrlConstants.JSP_URLS.MANAGE_SUPER_SERVICES_ICON)%>
			...
			<div id="formGrid" class="mb-5">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<%=NewThemeUiUtils.outputButtonSingleField("btnAddSuperService", BusinessAction.messageForKeyAdmin("labelAddSuperService"), NewThemeUiUtils.BUTTON_FLOAT_RIGHT, NewThemeUiUtils.BUTTON_FLOAT_RIGHT)%>
						...
						<% 
							...
							columnNames.add(BusinessAction.messageForKeyAdmin("labelServiceDescription"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelServiceTypeName"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelServicePriority"));
