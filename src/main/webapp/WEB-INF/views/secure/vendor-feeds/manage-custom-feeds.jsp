...
<body>
    ...
    <div id="content" class="app-content">
        ...
        <%=NewThemeUiUtils.outputPageHeader(BusinessAction.messageForKeyAdmin("labelManageCustomFeeds"), UrlConstants.JSP_URLS.MANAGE_CUSTOM_FEEDS_DASHBOARD_ICON)%>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <% 
                        ...
                        columnNames.add(BusinessAction.messageForKeyAdmin("labelInvoice"));
                        columnNames.add(BusinessAction.messageForKeyAdmin("labelQty"));
                        ...
                        columnNames.add(BusinessAction.messageForKeyAdmin("labelTotalAmount"));
