...
<html lang="en" data-bs-theme="dark">
	...
	<body>
		...
		<div id="content" class="app-content">
			...
			<%=NewThemeUiUtils.outputPageHeader(BusinessAction.messageForKeyAdmin("labelManageVendorFeeds"), UrlConstants.JSP_URLS.MANAGE_FEEDS_DASHBOARD_ICON)%>
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<% 
							...
							columnNames.add(BusinessAction.messageForKeyAdmin("labelMediaType"));
