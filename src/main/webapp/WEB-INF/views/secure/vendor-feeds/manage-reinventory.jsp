...
<html lang="en" data-bs-theme="dark">
	...
	<body>
		...
		<div id="content" class="app-content">
			...
			<%=NewThemeUiUtils.outputPageHeader(BusinessAction.messageForKeyAdmin("labelInventoryReStock"), UrlConstants.JSP_URLS.MANAGE_VENDOR_FEEDS_ICON)%>
					...
					<div class="card-body">
					  <%=NewThemeUiUtils.outputFormHiddenField(FieldConstants.ADD_URL, it)%>
						...
						<% 
							...
							columnNames.add(BusinessAction.messageForKeyAdmin("labelMinQty"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelMaxQty"));
