...
<html lang="en" data-bs-theme="dark">
	...
	<body>
		...
		<div id="content" class="app-content">
			...
			<%=NewThemeUiUtils.outputPageHeader(BusinessAction.messageForKeyAdmin("labelManufacturerOrderRequestStatus"), UrlConstants.JSP_URLS.MANAGE_VENDOR_FEEDS_ICON)%>
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<% 
							...
							columnNames.add(BusinessAction.messageForKeyAdmin("labelProductAvailability"));
							...
							columnNames.add(BusinessAction.messageForKeyAdmin("labelDispatchDate"));
							columnNames.add(BusinessAction.messageForKeyAdmin("labelDelay"));
