...
<div class="tab-content pt-3">
	...
	<div class="tab-pane fade" id="tab2">
		...
		<%=NewThemeUiUtils.outputSelectMultiInputField(FieldConstants.VENDOR_STORE_ID, BusinessAction.messageForKeyAdmin("labelVendorStoresOrderNotifications"), true, 1, itLocalVendorFields, "col-sm-3", "col-sm-5")%>	
