...
<div class="tab-content">
	...
	<div id="menu1" class="tab-pane fade in active">
		...
		<%=NewUiViewUtils.outputGlobalInputField("companyName", "Company name", true, 1, 30, it1, "text") %>
		
		<%=NewUiViewUtils.outputGlobalInputField("companyAddress", "Company address", true, 2, 30, it1, "text") %>
