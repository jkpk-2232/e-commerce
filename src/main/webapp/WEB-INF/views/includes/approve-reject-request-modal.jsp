...
<!-- BEGIN #modalEdit -->
<div class="modal fade" id="approveRejectEncashModel">
	...
	<div class="modal-dialog modal-xl">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<%=NewThemeUiUtils.outputInputField(FieldConstants.APPROVE_REJECT_REMARK, BusinessAction.messageForKeyAdmin("labelRemark"), false, 1, 30, itLocalTransferReject, "text", "col-sm-3", "col-sm-5")%>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-outline-default" id="btnARECancel" data-bs-dismiss="modal"><%=BusinessAction.messageForKeyAdmin("labelClose")%></button>
				<button type="button" class="btn btn-outline-theme" id="btnAREApprove"><%=BusinessAction.messageForKeyAdmin("labelApproved")%></button>
				<button type="button" class="btn btn-outline-theme" id="btnAREReject"><%=BusinessAction.messageForKeyAdmin("labelReject")%></button>
			</div>
