jQuery(document).ready(function() {
    ...
    jQuery("#btnExport").click(function(e) {
        ...
        redirectToUrl("/export/driver-transaction-history-reports.do?driverId=" + driverId + "&vendorId=" + vendorId + "&startDate=" + startDateFormatted + "&endDate=" + endDateFormatted + "&searchString=" + searchString);
    });
});
...
function loadDatatable(tempStartDate, tempEndDate) {
    ...
    var taxiDatatable = jQuery("#datatableDefault").dataTable({
        ...
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": basePath + "/manage-driver-transaction-history-reports/list.json",
