...
jQuery(document).ready(function() {
    ...
    selectCarAvailabilityWithServiceTypeId(jQuery("#fareAvailableCarListTransportation").val());
    selectCarAvailabilityWithServiceTypeId(jQuery("#fareAvailableCarListCourier").val());
    selectCarAvailabilityWithServiceTypeId(jQuery("#fareAvailableCarListEcommerce").val());
    ...
    jQuery("#btnSave").click(function() {
        ...
        var kvpairs = [];
        var form = document.forms.editMultiCity;
        ...
        document.forms["editMultiCity"].submit();
    });
