...
@Path("/manage-allbrands")
public class ManageAllBrandsAction extends BusinessAction {
	...
	public Response getProducts(@Context HttpServletRequest request, @Context HttpServletResponse response) throws ServletException, IOException {
		...
		return loadView(UrlConstants.JSP_URLS.MANAGE_ALL_BRANDS_JSP);
	}
	...
	protected String[] requiredJs() {
		...
		requiredJS.add("js/viewjs/vendor-feeds/manage-allbrands.js");
