...
@Path("/manage-reinventory")
public class ManageReinventoryAction extends BusinessAction {
	...
	public Response getProducts(@Context HttpServletRequest request, @Context HttpServletResponse response) throws ServletException, IOException {
		...
		return loadView(UrlConstants.JSP_URLS.MANAGE_RE_INVENTORY_JSP);
	}
	...
	protected String[] requiredJs() {
		...
		requiredJS.add("js/viewjs/vendor-feeds/manage-reinventory12.js");
