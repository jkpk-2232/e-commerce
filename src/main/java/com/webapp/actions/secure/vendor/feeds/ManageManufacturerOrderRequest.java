...
@Path("/manufacturer-order-request")
public class ManageManufacturerOrderRequest extends BusinessAction {
	...
	public Response getProducts(@Context HttpServletRequest request, @Context HttpServletResponse response) throws ServletException, IOException {
		...
		return loadView(UrlConstants.JSP_URLS.MANAGE_MANUFACTURER_ORDER_REQUEST_JSP );
	}
	...
	protected String[] requiredJs() {
		...
		requiredJS.add("js/viewjs/vendor-feeds/manufacturer-order-request.js");
