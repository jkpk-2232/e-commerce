...
@Path("/manage-low-inventory")
public class ManageLowInventory extends BusinessAction {
	...
	public Response get(@Context HttpServletRequest request, @Context HttpServletResponse response) throws ServletException, IOException {
		...
		return loadView(UrlConstants.JSP_URLS.MANAGE_LOW_INVENTORY_JSP);
	}
	...
	protected String[] requiredJs() {
		...
		requiredJS.add("js/viewjs/vendor-feeds/manage-lowinventory.js");
