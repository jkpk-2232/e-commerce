...
public class ManageOrdersActiveAction extends BusinessAction {

	@GET
	@Produces(MediaType.TEXT_HTML)
	//@formatter:off
	public Response getOrdersActive(
	...
	//@formatter:on
		...
		String orderStatusFilterOptions = DropDownUtils.getOrderStatusList(true, ProjectConstants.OrderDeliveryConstants.ORDERS_ACTIVE_TAB, ProjectConstants.DEFAULT_NUMBER_FOR_COMPARE);
		...
		return loadView(UrlConstants.JSP_URLS.MANAGE_ORDERS_ACTIVE_JSP);
	}

	@Override
	protected String[] requiredJs() {
		List<String> requiredJS = Arrays.asList(UrlConstants.JS_URLS.MANAGE_ORDERS_ACTIVE_JS);
