...
@Path("/manufacturer-order-request-status")
public class ManageManufacturerOrderRequestStatus extends BusinessAction {
	...
	public Response getProducts(@Context HttpServletRequest request, @Context HttpServletResponse response) throws ServletException, IOException {
		...
		return loadView(UrlConstants.JSP_URLS.MANAGE_MANUFACTURER_ORDER_REQUEST_STATUS_JSP);
	}
	...
	protected String[] requiredJs() {
		...
		requiredJS.add("js/viewjs/vendor-feeds/manage-manufacturer-order-request-status.js");
