...
@Path("/manage-history-all-others")
public class ManageHistoryAllOthersAction extends BusinessAction {
	...
	//@formatter:on
		...
		String orderStatusFilterOptions = DropDownUtils.getOrderStatusList(true, ProjectConstants.OrderDeliveryConstants.ORDERS_ALL_OTHERS_TAB, "-1");
		...
		return loadView("/secure/history/manage-history-all-others.jsp");
	}
	...
	protected String[] requiredJs() {
		...
		requiredJS.add("js/viewjs/history/manage-history-all-others.js");
