...
@Path("/edit-dynamic-car")
public class EditDynamicCarAction extends BusinessAction {

	@GET
	@Produces(MediaType.TEXT_HTML)
	//@formatter:off
	public Response editDynamicCarGet(
	...
	//@formatter:on
		...
		data.put(FieldConstants.CAR_MODEL_TYPE_ID, carTypeModel.getCarType());
		data.put(FieldConstants.CAR_TYPE_ID, carTypeModel.getCarTypeId());

		String carIconOptions = DropDownUtils.getCarIconsListOptions(carTypeModel.getIcon(), request.getContextPath());
		data.put(FieldConstants.CAR_ICON_OPTIONS, carIconOptions);

		data.put(FieldConstants.CAR_TYPE_ICON_IMAGE_URL_HIDDEN, carTypeModel.getCarTypeIconImage());
		data.put(FieldConstants.CAR_TYPE_ICON_IMAGE_URL_HIDDEN_DUMMY, StringUtils.validString(carTypeModel.getCarTypeIconImage()) ? carTypeModel.getCarTypeIconImage() : ProjectConstants.DEFAULT_IMAGE);

		data.put(FieldConstants.CANCEL_PAGE_REDIRECT_URL, UrlConstants.PAGE_URLS.MANAGE_DYNAMIC_CARS_URL);

		return loadView(UrlConstants.JSP_URLS.EDIT_DYNAMIC_CAR_JSP);
	}
	...
	//@formatter:off
	public Response editDynamicCarPost(
		@Context HttpServletRequest request, 
		@Context HttpServletResponse response,
	...
	//@formatter:on
		...
		data.put(FieldConstants.CAR_TYPE_ID, carTypeId);
		...
		carTypeModel.updateCarType(loginSessionMap.get(LoginUtils.USER_ID));
	...
	protected String[] requiredJs() {
		List<String> requiredJS = Arrays.asList(UrlConstants.JS_URLS.EDIT_DYNAMIC_CAR_JS);
