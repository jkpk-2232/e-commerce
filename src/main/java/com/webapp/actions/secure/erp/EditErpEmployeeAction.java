...
@Path("edit-erp-employee")
public class EditErpEmployeeAction extends BusinessAction {
	
	
	@GET
	@Produces(MediaType.TEXT_HTML)
	//@formatter:off
	public Response getEditErpEmployee (
	...
	//@formatter:on
		...
		String vendorStoreIdOptions = DropDownUtils.getERPBrandsFilterListOptions(vendorStoreIdList, loginSessionMap.get(LoginUtils.USER_ID), assignedRegionList);
		...
		return loadView(UrlConstants.JSP_URLS.EDIT_ERP_EMPLOYEES_JSP);
	}
	...
	protected String[] requiredJs() {
		List<String> requiredJS = Arrays.asList(UrlConstants.JS_URLS.EDIT_ERP_EMPLOYEE_JS);
