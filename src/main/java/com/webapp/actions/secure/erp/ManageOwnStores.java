...
@Path("/manage-own-stores")
public class ManageOwnStores extends BusinessAction {
    ...
    public Response get(@Context HttpServletRequest request, @Context HttpServletResponse response) throws ServletException, IOException {
        ...
        return loadView(UrlConstants.JSP_URLS.MANAGE_OWN_STORES_JSP);
    }
    ...
    private List<JSONObject> generateUserData() {
        ...
        usersList.add(createUser("4", 4, "Vendor 4", "Store D", "Pickup", "WARNING"));
    ...
    protected String[] requiredJs() {
        return new String[] {
            "js/viewjs/erp-users/manage-own-stores.js",
