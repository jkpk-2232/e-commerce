...
@Path("/add-erp-employee")
public class AddErpEmployeeAction extends BusinessAction {
	
	@GET
	@Produces(MediaType.TEXT_HTML)
	//@formatter:off
	public Response getAddErpEmployee (
	...
	//@formatter:on
		...
		if (!loginSessionMap.containsKey(UrlConstants.PAGE_URLS.MANAGE_ERP_EMPLOYEES_URL)) {
		...
		System.out.println("*** user id ***"+loginSessionMap.get(LoginUtils.USER_ID));
		System.out.println("*** region list  ***"+assignedRegionList);
		...
		data.put(FieldConstants.CANCEL_PAGE_REDIRECT_URL, UrlConstants.PAGE_URLS.MANAGE_ERP_EMPLOYEES_URL);
		
		System.out.println("**** vendor stores ***"+vendorStoreIdOptions);
		
		return loadView(UrlConstants.JSP_URLS.ADD_ERP_EMPLOYEES_JSP);
	}
	...
	//@formatter:on
		...
		userProfileModel.setRoleId(UserRoles.ERP_EMPLOYEE_ROLE_ID);
		...
		MulticityRegionUtils.addUserRegions(regionList, loginSessionMap.get(LoginUtils.USER_ID), userId, UserRoles.ERP_EMPLOYEE_ROLE_ID);
		...
		return redirectToPage(UrlConstants.PAGE_URLS.MANAGE_ERP_EMPLOYEES_URL);
	}
	...
	protected String[] requiredJs() {
		List<String> requiredJS = Arrays.asList(UrlConstants.JS_URLS.ADD_ERP_EMPLOYEE_JS);
