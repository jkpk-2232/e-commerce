...
@Path("/manual-booking-add-products")
public class ManualBookingsAddProductsAction extends BusinessAction {
	...
	public Response getProducts(@Context HttpServletRequest request, @Context HttpServletResponse response) throws ServletException, IOException {
		...
		return loadView(UrlConstants.JSP_URLS.MANUALBOOKING_ADDPRODUCTS_JSP);
	}
	...
	protected String[] requiredJs() {
		...
		requiredJS.add("js/viewjs/manual-bookings/manual-booking-add-products.js");
